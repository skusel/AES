...
namespace lskuse
{
  class AESKeySchedule
  {
    public:
      ...
      char* getRoundKey(unsigned round) const;
    ...
    private:
      ...
      static constexpr const unsigned LEN_128_TRANSFORMATIONS = LEN_128_WORD_ARRAY_SIZE / LEN_128_IN_BYTES;
      static constexpr const unsigned LEN_192_TRANSFORMATIONS = LEN_192_WORD_ARRAY_SIZE / LEN_192_IN_BYTES;
      static constexpr const unsigned LEN_256_TRANSFORMATIONS = LEN_256_WORD_ARRAY_SIZE / LEN_256_IN_BYTES;
